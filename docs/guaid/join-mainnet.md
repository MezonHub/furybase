...
For optimized node performance, edit the `~/.furybase/config/app.toml` file to enable the anti-spam mechanism and reject incoming transactions with less than the minimum gas prices:
