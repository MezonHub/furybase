...
func init() {
	proto.RegisterType((*MsgAddMintRewardAct)(nil), "furybase.furybase.fmintreward.MsgAddMintRewardAct")
	proto.RegisterType((*MsgAddMintRewardActResponse)(nil), "furybase.furybase.fmintreward.MsgAddMintRewardActResponse")
	proto.RegisterType((*MsgUpdateMintRewardAct)(nil), "furybase.furybase.fmintreward.MsgUpdateMintRewardAct")
	proto.RegisterType((*MsgUpdateMintRewardActResponse)(nil), "furybase.furybase.fmintreward.MsgUpdateMintRewardActResponse")
	proto.RegisterType((*MsgClaimMintReward)(nil), "furybase.furybase.fmintreward.MsgClaimMintReward")
	proto.RegisterType((*MsgClaimMintRewardResponse)(nil), "furybase.furybase.fmintreward.MsgClaimMintRewardResponse")
	proto.RegisterType((*MsgProvideRewardToken)(nil), "furybase.furybase.fmintreward.MsgProvideRewardToken")
	proto.RegisterType((*MsgProvideRewardTokenResponse)(nil), "furybase.furybase.fmintreward.MsgProvideRewardTokenResponse")
}

func init() { proto.RegisterFile("fmintreward/tx.proto", fileDescriptor_8dd96f257662b770) }
...
func (c *msgClient) AddMintRewardAct(ctx context.Context, in *MsgAddMintRewardAct, opts ...grpc.CallOption) (*MsgAddMintRewardActResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fmintreward.Msg/AddMintRewardAct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMintRewardAct(ctx context.Context, in *MsgUpdateMintRewardAct, opts ...grpc.CallOption) (*MsgUpdateMintRewardActResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fmintreward.Msg/UpdateMintRewardAct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimMintReward(ctx context.Context, in *MsgClaimMintReward, opts ...grpc.CallOption) (*MsgClaimMintRewardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fmintreward.Msg/ClaimMintReward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProvideRewardToken(ctx context.Context, in *MsgProvideRewardToken, opts ...grpc.CallOption) (*MsgProvideRewardTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fmintreward.Msg/ProvideRewardToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMintRewardAct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fmintreward.Msg/AddMintRewardAct",
	}
...
func _Msg_UpdateMintRewardAct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fmintreward.Msg/UpdateMintRewardAct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimMintReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fmintreward.Msg/ClaimMintReward",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ProvideRewardToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fmintreward.Msg/ProvideRewardToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fmintreward.Msg",
