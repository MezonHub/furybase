...
func init() {
	proto.RegisterType((*QueryGetProposalRequest)(nil), "furybase.furybase.fvote.QueryGetProposalRequest")
	proto.RegisterType((*QueryGetProposalResponse)(nil), "furybase.furybase.fvote.QueryGetProposalResponse")
	proto.RegisterType((*QueryGetProposalLifeRequest)(nil), "furybase.furybase.fvote.QueryGetProposalLifeRequest")
	proto.RegisterType((*QueryGetProposalLifeResponse)(nil), "furybase.furybase.fvote.QueryGetProposalLifeResponse")
}

func init() { proto.RegisterFile("fvote/query.proto", fileDescriptor_fe9488996c0b15b7) }
...
func (c *queryClient) GetProposal(ctx context.Context, in *QueryGetProposalRequest, opts ...grpc.CallOption) (*QueryGetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fvote.Query/GetProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetProposalLife(ctx context.Context, in *QueryGetProposalLifeRequest, opts ...grpc.CallOption) (*QueryGetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fvote.Query/GetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fvote.Query/GetProposal",
	}
...
func _Query_GetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fvote.Query/GetProposalLife",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fvote.Query",
