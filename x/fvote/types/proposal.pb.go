...
type Proposal struct {
	...
	Status      ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furybase.furybase.fvote.ProposalStatus" json:"status,omitempty" yaml:"prop_status"`
...
func init() {
	proto.RegisterEnum("furybase.furybase.fvote.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*Proposal)(nil), "furybase.furybase.fvote.Proposal")
}

func init() { proto.RegisterFile("fvote/proposal.proto", fileDescriptor_a18424b8936b52ae) }
