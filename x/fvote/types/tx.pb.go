...
type MsgSubmitProposalResponse struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furybase.furybase.fvote.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgSetProposalLife)(nil), "furybase.furybase.fvote.MsgSetProposalLife")
	proto.RegisterType((*MsgSetProposalLifeResponse)(nil), "furybase.furybase.fvote.MsgSetProposalLifeResponse")
	proto.RegisterType((*MsgSubmitProposal)(nil), "furybase.furybase.fvote.MsgSubmitProposal")
	proto.RegisterType((*MsgSubmitProposalResponse)(nil), "furybase.furybase.fvote.MsgSubmitProposalResponse")
}

func init() { proto.RegisterFile("fvote/tx.proto", fileDescriptor_a2fc698fa4472001) }
...
func (c *msgClient) SetProposalLife(ctx context.Context, in *MsgSetProposalLife, opts ...grpc.CallOption) (*MsgSetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fvote.Msg/SetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SubmitProposal(ctx context.Context, in *MsgSubmitProposal, opts ...grpc.CallOption) (*MsgSubmitProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fvote.Msg/SubmitProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fvote.Msg/SetProposalLife",
	}
...
func _Msg_SubmitProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fvote.Msg/SubmitProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fvote.Msg",
