...
func init() {
	proto.RegisterType((*SwapPool)(nil), "furybase.furybase.fdex.SwapPool")
}

func init() { proto.RegisterFile("fdex/models.proto", fileDescriptor_cc88587beb583d4f) }
