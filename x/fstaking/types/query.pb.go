...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furybase.furybase.fstaking.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furybase.furybase.fstaking.QueryParamsResponse")
	proto.RegisterType((*QueryInflationBaseRequest)(nil), "furybase.furybase.fstaking.QueryInflationBaseRequest")
	proto.RegisterType((*QueryInflationBaseResponse)(nil), "furybase.furybase.fstaking.QueryInflationBaseResponse")
	proto.RegisterType((*QueryValidatorWhitelistRequest)(nil), "furybase.furybase.fstaking.QueryValidatorWhitelistRequest")
	proto.RegisterType((*QueryValidatorWhitelistResponse)(nil), "furybase.furybase.fstaking.QueryValidatorWhitelistResponse")
	proto.RegisterType((*QueryValidatorWhitelistSwitchRequest)(nil), "furybase.furybase.fstaking.QueryValidatorWhitelistSwitchRequest")
	proto.RegisterType((*QueryValidatorWhitelistSwitchResponse)(nil), "furybase.furybase.fstaking.QueryValidatorWhitelistSwitchResponse")
	proto.RegisterType((*QueryDelegatorWhitelistRequest)(nil), "furybase.furybase.fstaking.QueryDelegatorWhitelistRequest")
	proto.RegisterType((*QueryDelegatorWhitelistResponse)(nil), "furybase.furybase.fstaking.QueryDelegatorWhitelistResponse")
	proto.RegisterType((*QueryDelegatorWhitelistSwitchRequest)(nil), "furybase.furybase.fstaking.QueryDelegatorWhitelistSwitchRequest")
	proto.RegisterType((*QueryDelegatorWhitelistSwitchResponse)(nil), "furybase.furybase.fstaking.QueryDelegatorWhitelistSwitchResponse")
}

func init() { proto.RegisterFile("fstaking/query.proto", fileDescriptor_e22409a29fe39f84) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) InflationBase(ctx context.Context, in *QueryInflationBaseRequest, opts ...grpc.CallOption) (*QueryInflationBaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/InflationBase", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ValidatorWhitelist(ctx context.Context, in *QueryValidatorWhitelistRequest, opts ...grpc.CallOption) (*QueryValidatorWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/ValidatorWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ValidatorWhitelistSwitch(ctx context.Context, in *QueryValidatorWhitelistSwitchRequest, opts ...grpc.CallOption) (*QueryValidatorWhitelistSwitchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/ValidatorWhitelistSwitch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DelegatorWhitelist(ctx context.Context, in *QueryDelegatorWhitelistRequest, opts ...grpc.CallOption) (*QueryDelegatorWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/DelegatorWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DelegatorWhitelistSwitch(ctx context.Context, in *QueryDelegatorWhitelistSwitchRequest, opts ...grpc.CallOption) (*QueryDelegatorWhitelistSwitchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fstaking.Query/DelegatorWhitelistSwitch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/Params",
	}
...
func _Query_InflationBase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/InflationBase",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ValidatorWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/ValidatorWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ValidatorWhitelistSwitch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/ValidatorWhitelistSwitch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DelegatorWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/DelegatorWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DelegatorWhitelistSwitch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fstaking.Query/DelegatorWhitelistSwitch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fstaking.Query",
