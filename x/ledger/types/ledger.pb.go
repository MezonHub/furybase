...
type PoolDetail struct {
	...
	Status      PoolStatus `protobuf:"varint,5,opt,name=status,proto3,enum=furybase.furybase.ledger.PoolStatus" json:"status,omitempty"`
}
...
type BondSnapshot struct {
	...
	BondState PoolBondState `protobuf:"varint,6,opt,name=bond_state,json=bondState,proto3,enum=furybase.furybase.ledger.PoolBondState" json:"bond_state,omitempty"`
}
...
type BondRecord struct {
	...
	State  LiquidityBondState                     `protobuf:"varint,6,opt,name=state,proto3,enum=furybase.furybase.ledger.LiquidityBondState" json:"state,omitempty"`
}
...
type IcaPoolDetail struct {
	...
	Status            IcaPoolStatus `protobuf:"varint,3,opt,name=status,proto3,enum=furybase.furybase.ledger.IcaPoolStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("furybase.furybase.ledger.PoolStatus", PoolStatus_name, PoolStatus_value)
	proto.RegisterEnum("furybase.furybase.ledger.PoolBondState", PoolBondState_name, PoolBondState_value)
	proto.RegisterEnum("furybase.furybase.ledger.BondAction", BondAction_name, BondAction_value)
	proto.RegisterEnum("furybase.furybase.ledger.LiquidityBondState", LiquidityBondState_name, LiquidityBondState_value)
	proto.RegisterEnum("furybase.furybase.ledger.OriginalTxType", OriginalTxType_name, OriginalTxType_value)
	proto.RegisterEnum("furybase.furybase.ledger.IcaPoolStatus", IcaPoolStatus_name, IcaPoolStatus_value)
	proto.RegisterEnum("furybase.furybase.ledger.InterchainTxStatus", InterchainTxStatus_name, InterchainTxStatus_value)
	proto.RegisterType((*ChainEra)(nil), "furybase.furybase.ledger.ChainEra")
	proto.RegisterType((*Pool)(nil), "furybase.furybase.ledger.Pool")
	proto.RegisterType((*BondPipeline)(nil), "furybase.furybase.ledger.BondPipeline")
	proto.RegisterType((*EraSnapshot)(nil), "furybase.furybase.ledger.EraSnapshot")
	proto.RegisterType((*EraUnbondLimit)(nil), "furybase.furybase.ledger.EraUnbondLimit")
	proto.RegisterType((*PoolDetail)(nil), "furybase.furybase.ledger.PoolDetail")
	proto.RegisterType((*LinkChunk)(nil), "furybase.furybase.ledger.LinkChunk")
	proto.RegisterType((*BondSnapshot)(nil), "furybase.furybase.ledger.BondSnapshot")
	proto.RegisterType((*ExchangeRate)(nil), "furybase.furybase.ledger.ExchangeRate")
	proto.RegisterType((*TotalProtocolFee)(nil), "furybase.furybase.ledger.TotalProtocolFee")
	proto.RegisterType((*EraExchangeRate)(nil), "furybase.furybase.ledger.EraExchangeRate")
	proto.RegisterType((*UnbondRelayFee)(nil), "furybase.furybase.ledger.UnbondRelayFee")
	proto.RegisterType((*Unbonding)(nil), "furybase.furybase.ledger.Unbonding")
	proto.RegisterType((*BondRecord)(nil), "furybase.furybase.ledger.BondRecord")
	proto.RegisterType((*Signature)(nil), "furybase.furybase.ledger.Signature")
	proto.RegisterType((*RParams)(nil), "furybase.furybase.ledger.RParams")
	proto.RegisterType((*IcaAccount)(nil), "furybase.furybase.ledger.IcaAccount")
	proto.RegisterType((*IcaPoolDetail)(nil), "furybase.furybase.ledger.IcaPoolDetail")
}
