...
func init() {
	proto.RegisterType((*MsgAddDenom)(nil), "furybase.furybase.fbank .MsgAddDenom")
	proto.RegisterType((*MsgAddDenomResponse)(nil), "furybase.furybase.fbank .MsgAddDenomResponse")
}

func init() { proto.RegisterFile("fbank /tx.proto", fileDescriptor_c7b27080a32af813) }
...
func (c *msgClient) AddDenom(ctx context.Context, in *MsgAddDenom, opts ...grpc.CallOption) (*MsgAddDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fbank .Msg/AddDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fbank .Msg/AddDenom",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fbank .Msg",
