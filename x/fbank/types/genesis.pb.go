...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furybase.furybase.fbank .GenesisState")
	proto.RegisterType((*AddressPrefix)(nil), "furybase.furybase.fbank .AddressPrefix")
}

func init() { proto.RegisterFile("fbank /genesis.proto", fileDescriptor_fd1f8a6f057161fb) }
