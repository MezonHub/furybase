...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furybase.furybase.fbank .QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furybase.furybase.fbank .QueryParamsResponse")
	proto.RegisterType((*QueryAddressPrefixRequest)(nil), "furybase.furybase.fbank .QueryAddressPrefixRequest")
	proto.RegisterType((*QueryAddressPrefixResponse)(nil), "furybase.furybase.fbank .QueryAddressPrefixResponse")
}

func init() { proto.RegisterFile("fbank /query.proto", fileDescriptor_0cb13210cbef7429) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fbank .Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AddressPrefix(ctx context.Context, in *QueryAddressPrefixRequest, opts ...grpc.CallOption) (*QueryAddressPrefixResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furybase.furybase.fbank .Query/AddressPrefix", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fbank .Query/Params",
	}
...
func _Query_AddressPrefix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furybase.furybase.fbank .Query/AddressPrefix",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furybase.furybase.fbank .Query",
